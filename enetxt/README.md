...
[`../docs/OXT-ENGINE-NOTES.md`](https://github.com/SethMorrowSoftware/xtalk-suite/blob/main/docs/OXT-ENGINE-NOTES.md) 1.7 and 6.4, and
...
enetxt is developed in the **xTalk suite** monorepo at https://github.com/SethMorrowSoftware/xtalk-suite, where it is the
`enetxt/` member, and is published on its own at https://github.com/SethMorrowSoftware/enetxt (a repository the split creates; until it exists, the member's only home is the suite).
