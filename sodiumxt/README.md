...
SodiumXT is developed in the **xTalk suite** monorepo at https://github.com/SethMorrowSoftware/xtalk-suite, where it is the
`sodiumxt/` member, and is published on its own at https://github.com/SethMorrowSoftware/SodiumXT.
