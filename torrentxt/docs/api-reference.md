...
> -20 and -24, 106/106 on Windows on 2026-09-24 and on Linux x86_64 on 2026-09-25;
...
> `btDhtPutMutable`, which no build older than 2026-09-08 passes, on a DLL committed
> 2026-09-12 (the maintainer's account; its bitness not recorded), and the 2026-09-25 run
> held it on that release's `x86_64-linux` library (the maintainer's account). The
