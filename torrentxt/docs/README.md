...
| [TorrentXT-IMPLEMENTATION-PLAN.md](TorrentXT-IMPLEMENTATION-PLAN.md) | The original design brief and specification. A design record, not a status page: the as-built account lives in `../CLAUDE.md`. |
