...
| the binding on a real engine | `tests/torrent-selftest.livecodescript`, folded into the suite paste | an OXT pass: 106/106 on Windows 2026-09-24, and on Linux x86_64 and Windows x86_64, last counted 2026-09-25 |
...
The ledger of dated engine records, and what is still static (the 32-bit Windows DLL, the
32-bit Linux library, macOS, the demos), is in `../CLAUDE.md`.
