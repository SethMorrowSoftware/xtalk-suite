...
among what ran) and **2026-09-25** (Linux, 64-bit: the same 277 / 0 / 2, its first record naming
Linux); the relay connect / handshake / publish / ok path is **live-proven 2026-08-24** (all in
the ledger). The receive leg (REQ, EVENT, EOSE, CLOSED, NOTICE), NIP-42, every ws:// path
