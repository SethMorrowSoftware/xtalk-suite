...
> 2026-09-24 (Windows, the engine reports Win32) and 2026-09-25 (Linux and Windows). The `nxr*`
> surface is split: `nxrConnect` through publish and the relay's ok-confirm are LIVE-PROVEN
> 2026-08-24 against wss://nos.lol; the receive leg, the NIP-42 exchange and every ws:// path
> keep "verified statically; needs a live-relay pass" (`05-relay-client.md`).
