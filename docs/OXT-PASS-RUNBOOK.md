...
### 4.10 archivext (inventory item 36 - the member with NO engine evidence yet)

Everything is first-time here too, and unlike nostrxt this member's other
