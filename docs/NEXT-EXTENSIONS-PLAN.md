...
| Real-time (reliable UDP) | **ENet** | low-latency peer messaging (games, presence, collab) | **Phase 1 built** - `enetxt/` (standalone-ready folder; enx_ ABI v2, full Part III.4 surface incl. the lossless stash drain; smoke test 85 checks green under ASan/UBSan; LAN chat demo; needs an OXT pass) |
