...
| riptide | app | phases 1-4 done on two machines, 2026-08-13 and 2026-08-15; harness 489/0/2 in the suite paste, Windows, 2026-09-24 (the day's second and third runs; its first read 487/2/2: a stale capability count, and a u64 bound the engine let through, engine note 2.10; both fixed and green that evening, and the third run's probe named the engine's comparison rule) | live passes of phases 5-8; the faststart re-run; the boot re-paste |
