...
| box2dxt | 5 platforms, ABI 4 | Kit harness v30: 375/0 Windows, 2026-08-20; 374/1 Linux, 2026-08-21 (the red is `playLoudness` readback, engine note 5.4) | the harness v32 total (v31 has no record of its own); the five game stacks since the 2026-08-14 fold; risk R1 on Linux and macOS |
