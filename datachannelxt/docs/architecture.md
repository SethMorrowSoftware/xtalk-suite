...
carried from its siblings, TorrentXT above all.
...
- The queue is **bounded** (65536 events / 32 MiB of payload - far beyond what
...
`DCX_MAX_MESSAGE` (60000 bytes) bounds every message BOTH ways: sends over it
