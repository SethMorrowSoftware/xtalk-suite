#!/usr/bin/env bash
# run-gates.sh - datachannelxt's OWN gate list: what CI and a contributor run.
...
# than on an engine.
echo "== datachannelxt: tools/check-record-registry.py =="
...
echo "== datachannelxt: src/code/MANIFEST.sha256 =="
