...
2026-09-25, on Linux and on Windows), and coinxt's wallet, which carries OnionXT, synced real testnet
wallets over Tor through a v3 onion (Esplora on port 80, Electrum on port 143) on 2026-09-02/03. Still
...
the 2026-08-23/24 socket-message changes on a live socket (the harness's offline half, each named
