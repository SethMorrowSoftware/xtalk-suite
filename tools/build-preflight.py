...
-- The two members that ship a SECOND, pure-script half. Neither is needed for
-- the suite paste - which embeds both - so an absent one is a SKIP with the one
-- line that makes it run, not a defect.
